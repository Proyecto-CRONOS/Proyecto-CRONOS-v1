...
export const SECONDARY_COLOR = '#3D6F8C' // FIXME: Secondary color
export const SECONDARY_TEXT_COLOR = '#333' // FIXME: Secondary text color
export const INACTIVE_COLOR = 'gray' // FIXME: Inactive color
export const BUTTON_COLOR = '#DBE285'
